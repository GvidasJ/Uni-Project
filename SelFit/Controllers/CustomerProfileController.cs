...
namespace SelFit.Controllers
{
    ...
    public class CustomerProfileController : ControllerBase
    {
        ...
        [HttpGet("{id}"), Authorize(Roles = "Customer, Admin")]
        public async Task<ActionResult> GetCustomerById([FromRoute] Guid id)
        {
            ...
            if (customer == null)
            {
                return BadRequest($"Customer by Id {id} not found.");
            }

            return Ok(customer);
        }

        [HttpPut("{id}"), Authorize(Roles = "Customer, Admin")]
        ...
        public async Task<ActionResult<List<CustomerProfileModel>>> GetCustomers()
        {
            ...
            {
                return BadRequest("There are no customers.");
            }
