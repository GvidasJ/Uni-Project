...
namespace SelFit.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        [HttpPost("create-product"), Authorize(Roles = "Seller, Admin")]
        ...
        [HttpPut("update-product/{id}"), Authorize(Roles = "Seller, Admin")]
        ...
        [HttpGet("get-product/{id}"), Authorize]
        ...
        public async Task<ActionResult<ProductDto>> GetAllProduct()
        {
        ...
        [HttpDelete("delete-product/{id}"), Authorize(Roles = "Seller, Admin")]
